                    ...
                    "examples": {
                        ...
                        "sparse_data": {
                            ...
                            "value": {
                                ...
                                "common_books": [
                                    {
                                        ...
                                        "user1_rating": 4,
                                        "user2_rating": 3,
                                        "user1_review": "Finally got around to reading this classic!",
                                        "user2_review": "",
                                        "user1_shelves": "read",
                                        "user2_shelves": "read",
                                        "average_rating": 4.29,
                                        "publication_year": 1937.0
                                    },
                                    {
                                        "book_id": "77203",
                                        "title": "The Kite Runner",
                                        "author": "Khaled Hosseini",
                                        "link": "https://www.goodreads.com/book/show/77203",
                                ...
                                "common_authors": [
                                    {
                                        "author": "J.R.R. Tolkien",
                                        "user1_books": [
                                            {"title": "The Hobbit, or There and Back Again", "shelves": "read", "book_id": "5907"},
                                            {"title": "The Lord of the Rings", "shelves": "read", "book_id": "33"}
                                        ],
                                        "user2_books": [
                                            {"title": "The Hobbit, or There and Back Again", "shelves": "read", "book_id": "5907"}
                                        ]
                                    },
                                    {
                                        "author": "Khaled Hosseini",
                                        "user1_books": [
                                            {"title": "The Kite Runner", "shelves": "read", "book_id": "77203"}
                                        ],
                                        "user2_books": [
                                            {"title": "The Kite Runner", "shelves": "read", "book_id": "77203"}
                                        ]
                                ...
                                "common_books_count": 14,
                                "common_read_books_count": 10,
                                "era_similarity": 26.2,
                                "common_authors_count": 17,
                                "ai_insights": {
                                    "genre_insights": {
                                        "user1_preferences": ["Non-Fiction", "Science Fiction", "Fantasy", "Historical Fiction"],
                                        "user2_preferences": ["Non-Fiction", "Fantasy", "Literary Fiction", "Science Fiction"],
                                        "shared_genres": ["Fantasy", "Non-Fiction", "Science Fiction"],
                                        "recommendations": ["Consider exploring Historical Fiction together", "Both might enjoy Science books"]
                                    },
                                    "fiction_nonfiction": {
                                        "user1_ratio": 0.68,
                                        "user2_ratio": 0.25,
                                        "compatibility": "User1 prefers fiction while User2 favors non-fiction. Great opportunity to expand horizons."
                                    },
                                    "reading_style": {
                                        "user1_summary": "Reads contemporary and classic works with character-driven narratives.",
                                        "user2_summary": "Favors literary fiction and non-fiction with themes of identity.",
                                        "compatibility_score": 0.7,
                                        "compatibility_details": "Both appreciate well-crafted narratives and character development."
                                    },
                                    "book_recommendations": {
                                        "for_both": ["Dune by Frank Herbert", "Circe by Madeline Miller"],
                                        "for_user1": ["The Devil in the White City by Erik Larson"],
                                        "for_user2": ["The Song of Achilles by Madeline Miller"]
                                    }
                                },
                                "blend": {
                                    "score": 83.4,
